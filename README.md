...
[![gzipsize-lite](http://img.badgesize.io/https://unpkg.com/es6-tween/lite/Tween.min.js?compression=gzip&cache=false&label=lite%20size%20gzip)](http://unpkg.com/es6-tween/lite/Tween.min.js)
