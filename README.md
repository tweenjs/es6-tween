...
Download the [library](https://raw.githubusercontent.com/tweenjs/tween.js/master/dist/Tween.js) and include it in your code:
...
```html
<script src="bower_components/tweenjs/dist/Tween.js"></script>
```
